...
A Colab‑friendly Mini Retrieval‑Augmented Generation (RAG) pipeline built with **ChromaDB** and **Hugging Face models**.  
It ingests job description text, retrieves and reranks relevant chunks, and generates grounded answers with citations.  

**Features**
- Document chunking and embedding with Hugging Face
